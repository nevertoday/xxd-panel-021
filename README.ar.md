<p align="center">
  <img src="./assets/banner.svg" alt="لافتة مشروع XXD Panel 021" width="1200">
</p>

<div align="center" dir="rtl">

# 🦁 XXD Panel 021｜تجاوز الحقل الأسود

### يجعل موضوع الصورة يخترق حدود مستطيل واحد أسود خالص
...
<table>
  <tr>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2090264725116551641"><img src="./assets/examples/sample-01.jpg" alt="XXD Panel 021 نموذج 1"></a></td>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2090264725116551641"><img src="./assets/examples/sample-02.jpg" alt="XXD Panel 021 نموذج 2"></a></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 021 نموذج 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 021 نموذج 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 021 نموذج 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 021 نموذج 8"></td>
  </tr>
</table>

## نماذج إضافية 3:4 بتكوين أعلى–أسفل

تعيد هذه الأعمال الأربعة استخدام المصادر المستقلة نفسها في مجموعة 16:9 أعلاه، لكن داخل لوحات كاملة 3:4 بتكوين أعلى–أسفل. تبقى الصورة الواقعية في الأعلى، ويُعاد بناء التصميم السفلي وفق الموجّه الأصلي لـ Panel 021. لا يُولَّد النص الإنجليزي إلا من محتوى كل صورة أو مزاجها أو دلالتها، وقد روجعت النتائج واحدةً واحدة.

<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 021 نموذج إضافي أعلى–أسفل 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 021 نموذج إضافي أعلى–أسفل 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 021 نموذج إضافي أعلى–أسفل 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 021 نموذج إضافي أعلى–أسفل 4"></td>
  </tr>
</table>
...
<p align="center"><a href="https://x.com/xiaoxiaodong01/status/2090264725116551641">عرض المنشور الأصلي والتوجيه كاملاً ←</a></p>

تعرض هذه النماذج الدافع الجمالي للإصدار 021 فقط؛ ولا تصبح موضوعاتها أو تكوينها أو ألوانها أو نصوصها أو نسبة اللوحة السابقة مراجع للتوليد أو إعدادات افتراضية حالية.

<div dir="rtl">

> مستطيل أسود خالص · معظم الموضوع في الداخل · سمة واحدة تخترق الحد · خط نسخ مهتز · شكل سلبي أبيض ومساحات رمادية ضئيلة

XXD Panel 021 مهارة لتوليد الصور مخصّصة لـ Codex والوكلاء المتوافقين. تثبّت من الصورة الهوية والمحيط والوضع والحركة والوظيفة والعلاقة، ثم تجعل مستطيلاً واحداً أفقياً أو عمودياً أسود خالصاً هو المجال الرئيسي. يبقى معظم الموضوع داخله، وتعبر بنية واحدة هي الأوضح في التعرّف الحد بصورة طبيعية.

يُعاد بناء الموضوع بخط حبر أو قلم تقني أو أثر نسخ أسود يتفاوت سمكه قليلاً، ويرتجف، وينقطع محلياً، ويُعاد رسمه بقدر محدود. يحمل الشكل السلبي الأبيض قابلية التعرّف، ولا تُستخدم المساحات الرمادية إلا بقدر ضئيل لتوضيح البنية. يجعل البياض الواسع والوضع غير المتناظر والقص الموضعي والنص التحريري الصغير فعل الاختراق ذكياً ومقتصداً.
...
يناسب **Panel 021** الأعمال التي تحتاج إلى الاحتفاظ بجوهر الصورة الأصلية مع السعي إلى هذا الاتجاه البصري: **يجعل موضوع الصورة يخترق حدود مستطيل واحد أسود خالص**. يبدأ من الاستخدام المقصود والنتيجة المطلوبة، ثم يحدد التكوين والمقاس والنص وصيغة التسليم.
...
> استخدم XXD Panel 021 لهذه الصورة، واقترح أولاً أنسب تكوين ومقاس.
...
## تحقق سريع: هل XXD Panel 021 مناسب لك؟

| ما الذي يهمك؟ | ما الذي يقدمه هذا الأسلوب؟ |
|---|---|
| **النتيجة التي ستحصل عليها** | يجعل موضوع الصورة يخترق حدود مستطيل واحد أسود خالص |
| **السمات التي تُعرف من النظرة الأولى** | مستطيل أسود خالص · معظم الموضوع في الداخل · سمة واحدة تخترق الحد · خط نسخ مهتز · شكل سلبي أبيض ومساحات رمادية ضئيلة |
...
تعكس 021 هذا الترتيب:

```text
تثبيت حقائق المصدر ← اختيار مستطيل واحد أفقي أو عمودي أسود خالص ← وضع معظم الموضوع داخله ← جعل سمة حاسمة واحدة فقط تخترق الحد ← إعادة بناء الموضوع بخط أسود مهتز ومتقطع ومعاد الرسم قليلاً وبشكل سلبي أبيض ← الإنهاء بنصوص دقيقة على الحد أو الشكل السلبي أو اتجاه الاختراق
```

إذا أمكن استبدال المصدر بصورة لا صلة لها من دون تغيير جوهري في اتجاه المستطيل أو موضع الموضوع أو سمة الاختراق أو المحيط أو الشكل السلبي الأبيض أو النص، فالنتيجة ليست 021.
...
- **خط نسخ خشن:** يتفاوت الخط الأسود قليلاً في السمك، ويرتجف، وينقطع محلياً، ويقبل إعادة رسم محدودة؛ ويُرفض الخط المتجهي الناعم الثابت.
...
- **بلا لون:** ورق شبه أبيض وأسود خالص وخط أسود ومساحات رمادية ضئيلة فقط، بلا لون بارز أو تدرج.
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 021. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
/xxd-panel-021 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-021 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-021 photo.jpg --mode design-only --size 3:4 --text prompt --locale ar-SA

# استخدام النص الحرفي بلا إعادة صياغة أو ترجمة أو عنوان إضافي
/xxd-panel-021 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-021 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 021 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-021 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بـ `~/.claude/skills/xxd-panel-021`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
- [مهايئ التشغيل الصيني](references/xxd-panel-021-prompt.zh-CN.md)
- [مهايئ التشغيل الإنجليزي](references/xxd-panel-021-prompt.en.md)
