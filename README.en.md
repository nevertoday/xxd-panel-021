...
| --- | --- | --- |
| `top-bottom` | user-confirmed whole canvas | one complete generation: high-fidelity source above, 021 design below, approximately 50/50 |
| `left-right` | user-confirmed whole canvas | one complete generation: high-fidelity source left, 021 design right, approximately 50/50 |
| `design-only` | user-confirmed whole canvas | 021 design fills the canvas; source remains invisible |
...
```text
/xxd-panel-021 photo.jpg --mode top-bottom,design-only --size auto,3:4,9:16 --text auto --locale ja-JP
```
