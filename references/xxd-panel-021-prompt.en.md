...
## Rough photocopy line and negative shape

Retain only essential outer contour, pose, and key structure. Draw with black ink-brush, technical-pen, or photocopy-line character: slightly varied weight, light jitter, local breaks, limited retracing, and real human error. It remains legible but never smooth, stable, uniform, or vector-polished.
